...
const EventsCard = () => {
  return (
    <Link href="/home/event"
      className="scroll-item flex flex-col items-stretch border border-none rounded-2xl overflow-hidden shadow-md min-w-[60%]"
    >
      ...
      <div className="border-none rounded-2xl event-card-short-info-section flex flex-col px-3 py-5 gap-3 items-start">
        <p className="bg-purple-200 border-none rounded-2xl text-purple-600 w-fit px-3 font-bold">
          Live Concert
        </p>
        <h3 className="text-wrap leading-5 text-lg font-bold">
          The Local Train - Live in Bengaluru
        </h3>
